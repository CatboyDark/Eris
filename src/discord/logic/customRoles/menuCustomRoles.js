...
const customRolesMenu = createRow([
    {
        ...
        options: [
            {
                value: 'guildRankRoles',
                label: 'Guild Rank Roles',
                desc: 'Guild ranks'
            },
            {
                value: 'levelRoles',
            ...
            {
                value: 'nwRoles',
                label: 'Networth Roles',
                desc: 'Skyblock networth'
            },
            {
                value: 'skillRoles',
                label: 'Skill Roles',
                desc: 'Skyblock skills'
            },
            {
                value: 'cataRoles',
                label: 'Dungeon Roles',
                desc: 'Skyblock Catacombs levels'
            },
            {
                value: 'classRoles',
                label: 'Dungeon Class Roles',
                desc: 'Dungeon Class levels'
            },
            {
                value: 'slayerRoles',
                label: 'Slayer Roles',
                desc: 'Skyblock slayer levels'
            }
        ]
    }
]);
...
async function customRoles(interaction)
{
    await interaction.update({
        embeds: [customRolesMsg],
        components: [customRolesMenu, back]
    });
}

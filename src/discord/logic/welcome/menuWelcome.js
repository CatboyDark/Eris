...
const noWelcomeChannel = createError(
...
async function welcome(interaction)
{
    ...
    const { welcomeMsgButtons, welcomeRoleButtons, back } =
        await createButtons();
    interaction.update({
        embeds: [welcomeMsg],
        components: [welcomeMsgButtons, welcomeRoleButtons, back]
    });
    return true;
}
